...
// Phase C / bootstrap inversion (step 4): native port of workflows/cluster-settings-modals/preset-modal/
// preset-modal-labels.js (an AngularJS `constant`). Pure data — the per-cluster-type field labels /
// instructions / placeholders the preset modal renders. Consumed by preset-modal.component; replaces the
// bridged 'PresetModalLabels' injectable. Kept structurally identical (same _.assign/_.pick composition).
...
export const PRESET_MODAL_LABELS: any = {
