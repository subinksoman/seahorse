...
# Spark 3.x/4.x (modernization target 3.4.4). SparkR's getSparkSession / SparkDataFrame
# class / createDataFrame APIs are unchanged from the 2.x line, so the same body applies.
