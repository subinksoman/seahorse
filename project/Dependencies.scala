...
//  val json4s = "3.3.0"
   ...
   val json4s = if (sys.props.getOrElse("SPARK_VERSION", "4.2.0").startsWith("4.")) "4.0.7" else "3.7.0-M11"
  val jclouds = "2.1.0"
...
//  val scalatra = "2.4.0"
  ...
  val scalatra = if (sys.props.getOrElse("SPARK_VERSION", "4.2.0").startsWith("4.")) "2.8.4" else "2.7.1"
  val scoverage = "1.4.6"
//  val slick = "3.1.1"
